...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3e7fe7;
...
const char     CRYPTONOTE_NAME[]                             = "fog";
...
const int      P2P_DEFAULT_PORT                              = 15002;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 15003;
